...
export interface OriginSspItem {
  id: number
  title: string
  banner: string
  summary: string
...
export interface OriginSspResponse {
  error: number
  msg: string
  total: number
}

export interface OriginSspPaginationRequestPayload {
  limit: number
  offset: number
  created_at: number
  tag: string
...
export interface OriginSspPaginationResponse extends OriginSspResponse {
  data: OriginSspItem[]
  total: number
}

export interface SspItem extends CommonItem {}
